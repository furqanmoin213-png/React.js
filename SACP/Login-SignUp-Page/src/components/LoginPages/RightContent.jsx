...
<div className="w-full  h-[90%] flex justify-center items-center font-login-page">
  <div className="min-w-[27rem]">
    ...
    <form className="flex flex-col gap-1" onSubmit={handleSubmit(onSubmit)}>
      ...
      {...register("email")} className="w-full px-4 py-4 mb-3 border-1 border-input-border text-[1.2rem] text-gray-900"/>

    <label htmlFor="password" className="text-[1rem] text-Login-Text mb-1">
      Password
    </label>
    
    <input type="password" name="password" id="password" {...register("password")} placeholder="************" className=" w-full px-4 py-4  mb-5 border-1 flex justify-center items-center border-input-border font-[900] text-[1.2rem] text-gray-900"/>
